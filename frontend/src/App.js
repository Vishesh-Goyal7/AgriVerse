...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("http://13.127.4.82:3001/predict", {
        method: "POST",
  ...
  return (
    <div className="app-container">
      ...
      <div className="results-section">
        {predictions.map(pred => (
          <div key={pred.crop} className="crop-result">
            <img
              src={`https://13.127.4.82:3001/crop_images/${pred.crop.toLowerCase()}.jpeg`}
              alt={pred.crop}
      ...
      <div className="global-importance">
        ...
        <img
          src="https://13.127.4.82:3001/crop_images/global_importance.png"
